...
class TestLibVersionPin:
    ...
    def test_requirements_pins_lib_to_stable_tag(self):
        ...
        assert "@v0.124.3" in text, (
            "nousergon-lib should pin to v0.124.3 (nousergon_lib.health enrichment "
            "writer for config#1727 Phase C; lockstep with fleet at v0.124.3; bumped for nousergon_lib.quant.stats.trial_accumulator (config#2454)). "
