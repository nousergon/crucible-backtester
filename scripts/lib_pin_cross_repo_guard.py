...
MIRROR: this file must stay byte-identical to crucible-predictor's
...
# workflow fetches from. crucible-predictor's copy of this file swaps these.
OWN = "crucible-backtester"
SIBLING = "crucible-predictor"
